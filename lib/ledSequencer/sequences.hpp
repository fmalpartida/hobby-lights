...
uint16_t fastBlinkBurstLP0[]   = { 0b0101010101010101, 0b0000000000000000, 0b0000000000000000 };
uint16_t fastBlinkBurstLP90[]  = { 0b0000000001010101, 0b0101010100000000, 0b0000000000000000 };
uint16_t fastBlinkBurstLP180[] = { 0b0000000000000000, 0b0101010101010101, 0b0000000000000000 };
uint16_t fastBlinkBurstLP270[] = { 0b0000000000000000, 0b0000000001010101, 0b0101010100000000 };
...
t_sequence sequenceList[] =
{
   ...
   {SET_SEQUENCE(fastBlinkBurstLP0)},   // 19
   {SET_SEQUENCE(fastBlinkBurstLP90)},  // 20
   {SET_SEQUENCE(fastBlinkBurstLP180)}, // 21
   {SET_SEQUENCE(fastBlinkBurstLP270)}, // 22
