...
t_sequenceDesc cylonRaider1[LEDS_ON_BOARD] =
{
   {LED1, CHASER_1},
   {LED2, CHASER_2},
   {LED3, CHASER_3},
...
t_sequenceDesc cylonRaider2[LEDS_ON_BOARD] =
{
   {LED1, CHASER_1},
   {LED2, CHASER_2},
   {LED3, CHASER_3},
...
t_sequenceDesc crossingUS[LEDS_ON_BOARD] =
{
   {LED1, TRAFGRE1US},
   {LED2, TRAFYEL1US},
   {LED3, TRAFRED1US},
...
t_sequenceDesc crossingUK[LEDS_ON_BOARD] =
{
   {LED1, TRAFGRE1UK},
   {LED2, TRAFYEL1UK},
   {LED3, TRAFRED1UK},
...
const char cylonRaiderDesc1[] PROGMEM   = "CYLON RAIDER 1  ";
const char cylonRaiderDesc2[] PROGMEM   = "CYLON RAIDER 2  ";
const char cylonRaiderInvDesc[] PROGMEM = "CYLON RAIDER INV";
const char kitDesc[] PROGMEM            = "KIT             ";
const char crossingUSDesc[] PROGMEM     = "CROSSING US     ";
const char crossingUKDesc[] PROGMEM     = "CROSSING UK     ";
...
{ userDesc, airplane1Desc, airplane2Desc, helicopterDesc, emergencyCar1Desc,
   ...
   allFlickerDesc, allFastBlinkDesc, falconLightsDesc, cylonRaiderDesc1, cylonRaiderDesc2,
   cylonRaiderInvDesc, kitDesc, crossingUSDesc, crossingUKDesc,
...
{ user, airplane1, airplane2, helicopter, emergencyCar1, emergencyCar2,
   ...
   cylonRaider1, cylonRaider2, cylonRaiderInv, kit, crossingUS, crossingUK,
